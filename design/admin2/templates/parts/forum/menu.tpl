...
<h4>{'Forum'|i18n( 'design/admin/parts/forum/menu' )}</h4>
{* DESIGN: Header END *}</div></div>
{* DESIGN: Content START *}<div class="box-bc"><div class="box-ml"><div class="box-content">

{* Treemenu. *}
<div id="contentstructure">
{include uri='design:contentstructuremenu/content_structure_menu_dynamic.tpl' custom_root_node_id=ezini('TreeMenu','ForumRootNodeID','contentstructuremenu.ini')}
</div>

{* Trashcan. *}
{if ne( $ui_context, 'browse' )}
<div id="trash">
<a class="image-text" href={concat( '/content/trash/', ezini( 'NodeSettings', 'ForumRootNode', 'content.ini' ) )|ezurl} title="{'View and manage the contents of the trash bin.'|i18n( 'design/admin/parts/content/menu' )}"><img src={'trash-icon-16x16.gif'|ezimage} width="16" height="16" alt="{'Trash'|i18n( 'design/admin/parts/content/menu' )}" />&nbsp;<span>{'Trash'|i18n( 'design/admin/parts/content/menu' )}</span></a>
</div>
{/if}
